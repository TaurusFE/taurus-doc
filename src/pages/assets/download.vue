<template>
  <div class=" container">
    ...
    <div class="sgComponentWrapper">
      <div class="container grid-row">
        <div class="sg-content__header col-md-4">
          <h2 class="title--medium-small">Interaction Design</h2>
        </div>
        <div class="col-md-8">
          <div class="sg-content-item sg-content mix ready">
            <h2 class="title--small leader--small">Axure Libraries</h2>
    ...
    <div class="sgComponentWrapper">
      <div class="container grid-row">
        <div class="sg-content__header col-md-4">
          <h2 class="title--medium-small">Visual Design</h2>
        </div>
        <div class="col-md-8">
          <div class="sg-content-item sg-content mix ready">
            <h2 class="title--small leader--small">Sketch Libraries</h2>
            <div class="sg-content__markup sg-markdown">
          ...
          <div class="sg-content-item sg-content mix ready">
            ...
            <div class="sg-content__markup sg-markdown">
              <p>Preview UI kit for PDF.</p>
            </div>
            <a target="_blank" href="/static/file/UIkit.pdf" class="leader--small button button--default">UI Kit.pdf</a>
          </div>
          <div class="sg-content-item sg-content mix ready">
            <h2 class="title--small leader--small">UI Kit with the measurement</h2>
    ...
    <div class="sgComponentWrapper">
      <div class="container grid-row">
        <div class="sg-content__header col-md-4">
          <h2 class="title--medium-small">Fonts</h2>
        </div>
        <div class="col-md-8">
          <div class="sg-content-item sg-content mix ready">
            <h2 class="title--small leader--small">Icon Fonts</h2>
            <div class="sg-content__markup sg-markdown">
              <p>Icon Fonts.</p>
            </div>

<template>
  <t-popup v-model="visible" position="bottom" class="taurus-datetime">
    <t-picker
      :slots="dateSlots"
      @change="onChange"
      :visible-item-count="7"
      class="taurus-datetime-picker"
      ref="picker"
      show-toolbar>
      <span class="taurus-datetime-action taurus-datetime-cancel" @click="visible = false">{{ cancelText }}</span>
      <span class="taurus-datetime-action taurus-datetime-confirm" @click="confirm">{{ confirmText }}</span>
    </t-picker>
  </t-popup>
</template>

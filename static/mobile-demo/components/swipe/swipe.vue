<template>
  <div class="taurus-swipe">
    <div class="taurus-swipe-items-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="taurus-swipe-indicators" v-show="showIndicators">
      <div class="taurus-swipe-indicator"
